<%@ page title="" language="C#" masterpagefile="~/PaginasMaestras/mpAprobarRQ.master" autoeventwireup="true" inherits="Requerimiento_Default, App_Web_qu5m4qvq" %>
                    ...
                    <td width="30%" valign="top">
                        <table width="100%">
                            <tr>
                                ...
                                <td width="70%">
                                    <asp:TextBox ID="txtTipo_Requisicion" runat="server" Font-Size="XX-Small" Width="200px" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtOrden_Compra" runat="server" Font-Size="XX-Small" Width="200px" 
                                        ReadOnly="True" BackColor="#3399FF" ForeColor="White"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <td rowspan="2"><table border="1" width="100%"><tr><td>
                                               <asp:GridView ID="grvAprobacion" runat="server" Width="100%" 
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="Nombres" DataField="User_Nombre">
                                                        <HeaderStyle BackColor="#CCCCFF" Font-Bold="True" HorizontalAlign="Left" />
                                                        ...
                                                        <asp:BoundField DataField="Ara_Ind_Aprob" HeaderText="Aprob">
                ...
                <tr>
                    ...
                    <asp:GridView ID="grvAdjuntos" runat="server" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Codigo Adjunto" DataField="RAD_Codigo">
                                <HeaderStyle BackColor="#CCCCFF" Font-Bold="True" HorizontalAlign="Left" />
