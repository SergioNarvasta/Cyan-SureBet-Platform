<%@ page title="" language="C#" masterpagefile="~/PaginasMaestras/mpAprobarOrden.master" autoeventwireup="true" inherits="OrdenCompra_Default, App_Web_y3mzpy31" %>
                ...
                <tr>
                    <td Width="60%" valign="top">
                        <table Width="100%">
                            ...
                            <tr>
                                <td colspan="5">
                                    <asp:CheckBox ID="chkControlAlmacenServicios" runat="server" Enabled="False" 
                                        Text="Control de Almacenes de los Servicios" />
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td>
                        <asp:GridView ID="grvDetalle" runat="server" Width="100%" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="% Descto-1" DataField="OCD_Descuento1_Porcentaje" DataFormatString="{0:P2}">
                                <HeaderStyle BackColor="#CCCCFF" Font-Bold="True" HorizontalAlign="Center" />
                                <ItemStyle Width="100px" HorizontalAlign="Right" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Imp. Descto-1"  DataField="OCD_Descuento1_Importe" DataFormatString="{0:N3}">
                                <HeaderStyle BackColor="#CCCCFF" Font-Bold="True" HorizontalAlign="Center" />
                                <ItemStyle Width="100px" HorizontalAlign="Right" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="% Descto-2" DataField="OCD_Descuento2_Porcentaje" DataFormatString="{0:P3}">
                                <HeaderStyle BackColor="#CCCCFF" Font-Bold="True" HorizontalAlign="Center" />
                                <ItemStyle Width="100px" HorizontalAlign="Right" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Imp. Descto-2" DataField="OCD_Descuento2_Importe" DataFormatString="{0:N3}">
                                <HeaderStyle BackColor="#CCCCFF" Font-Bold="True" HorizontalAlign="Center" />
                                <ItemStyle Width="100px" HorizontalAlign="Right" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="% Descto-3" DataField="OCD_Descuento3_Porcentaje" DataFormatString="{0:P3}">
                                <HeaderStyle BackColor="#CCCCFF" Font-Bold="True" HorizontalAlign="Center" />
                                <ItemStyle Width="100px" HorizontalAlign="Right" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Imp. Descto-3" DataField="OCD_Descuento3_Importe" DataFormatString="{0:N3}">
                                <HeaderStyle BackColor="#CCCCFF" Font-Bold="True" HorizontalAlign="Center" />
                                <ItemStyle Width="100px" HorizontalAlign="Right" />
                                </asp:BoundField>
                            </Columns>
                                ...
                                <td valign="top">
                                    <asp:GridView ID="grvAprobacion" runat="server" Width="100%" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Aprobado" DataField="AOA_Indicador_Aprobacion" >
                                            <HeaderStyle BackColor="#CCCCFF" Font-Bold="True" HorizontalAlign="Center" />
                                            <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            ...
                                            <asp:BoundField HeaderText="Nombre" DataField="AOA_Nombres" >
                                            <HeaderStyle BackColor="#CCCCFF" Font-Bold="True" HorizontalAlign="Center" />
                                            <ItemStyle Width="400px" />
                                            </asp:BoundField>
                                        </Columns>
