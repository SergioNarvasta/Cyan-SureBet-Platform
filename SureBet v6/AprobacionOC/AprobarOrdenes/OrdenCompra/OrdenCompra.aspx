<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasMaestras/mpAprobarOrden.master" AutoEventWireup="true" CodeFile="OrdenCompra.aspx.cs" Inherits="OrdenCompra_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" Runat="Server">
    ...
    <table width="100%" 
        style="font-family: 'Courier New', Courier, 'espacio sencillo'; font-size: 12px" 
                        ...
                        <table width="100%" 
                            ...
                            <tr>
                                <td width="25%">Serie: <asp:TextBox ID="txtSerie" runat="server" ReadOnly="True" 
                                        Width="75px" Font-Size="X-Small"></asp:TextBox></td>
                                <td width="30%">Número: 
                ...
                <tr>
                    <td Width="60%" valign="top">
                        <table Width="100%">
                            ...
                            <tr>
                                <td colspan="5">
                                    Ver Cuadro Comparativo o Sole Source:&nbsp;&nbsp;&nbsp;
                                    <asp:HyperLink ID="HypCuadroComparativo" runat="server" 
                                        ToolTip="click para ver Cuadro Comparativo">Ver cuadro comparativo...</asp:HyperLink>
                                    &nbsp;&nbsp;
                                    <asp:HyperLink ID="HypSoleSource" runat="server" 
                                        ToolTip="click para ver Sole Source">Ver Sole Source...</asp:HyperLink>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="5">
